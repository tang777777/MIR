...
parser.add_argument('--dataset_name', type=str, default='GEN_QM9_10k', help='use QM9_10k or ZINC_10k dataset')

# ===========================
# Filler Model
parser.add_argument('--filler_pretrain', action='store_true', help='whether pretraining the filler model')
parser.add_argument('--filler_epochs', type=int, default=140, help='define the pretraining epochs for the filler model')
parser.add_argument('--filler_generated_size', type=int, default=10000, help='define the generated size of the filler model')
parser.add_argument('--decoration_max_len', type=int, default=30, help='define the maximum length for the generated decorations')
...
parser.add_argument('--filler_max_lr', type=float, default=5e-6, help='define the maximum learning rate for the filler model')
...
parser.add_argument('--dis_pre_epochs', type=int, default=15, help='define the pretraining epochs for the discriminator model')
parser.add_argument('--dis_max_lr', type=float, default=5e-6, help='define the maximum learning rate for the discriminator model')
...
parser.add_argument('--adv_lr', type=float, default=4e-6, help='define the learning rate for the GAN or WGAN')
...
parser.add_argument('--gpus', type=int, default=0, help='the name of the CUDA')
